...
try {
    ...
    $query="select t.*, u.username,f.intitule from $table_name t left join utilisateur u on u.id_utilisateur=t.id_utilisateur
    left join formation f on f.id_formation=t.id_formation  ".$condition;
